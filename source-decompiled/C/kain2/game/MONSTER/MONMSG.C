...

{
  ...
  FUN_8007786c(instance,(int)unaff_s1);
  *(undefined4 *)(unaff_s0 + 0x15c) = unaff_s3;
...

{
  ...
  while (PurgeMessageQueue((__MessageQueue *)(unaff_s3 + 8)), in_v0 != (int *)0x0) {
    in_v0 = (int *)*in_v0;
    if (in_v0 != (int *)unaff_s2) {
      in_v0 = (int *)FUN_80084ac0();
    }
  }
  return;
}
